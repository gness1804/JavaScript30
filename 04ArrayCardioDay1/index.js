...
const sortInventors = () =>
  inventors.sort(({ year: aYear }, { year: bYear }) => aYear - bYear);
console.info('The sorted inventors:');
console.table(sortInventors());

// Array.prototype.reduce()
// 4. How many years did all the inventors live?
const getInventorLifespans = () =>
  inventors.reduce((acc, curr) => {
...
const sortInventorsByLifespan = () =>
  getInventorLifespans().sort(
    ({ lifespan: aLifespan }, { lifespan: bLifespan }) => aLifespan - bLifespan,
  );
...
console.info(
  'To see the solution to problem 6 about the Parisian boulevards, copy and paste the above code into the devtools on the Wikipedia link above.',
);
